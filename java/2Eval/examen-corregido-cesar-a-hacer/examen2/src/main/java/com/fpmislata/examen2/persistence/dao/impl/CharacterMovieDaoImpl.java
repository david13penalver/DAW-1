...
//    @Override
//    public List<CharacterMovieEntity> characterMovieEntityListByMovieId(int movieId) {
//        List<CharacterMovieEntity> characterMovieEntityList1;
//        for (CharacterMovieEntity characterMovieEntity : characterMovieEntityList) {
//            if (characterMovieEntityList.getMovieId() == movieId) {
//                characterMovieEntityList.add(characterMovieEntityList);
//            }
//        }
